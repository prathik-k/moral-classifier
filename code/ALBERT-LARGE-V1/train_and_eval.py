...
def getDataloaders(batch_size):
    try:
        ...
        test_dataloader = torch.load("../../../dataloaders/ALBERT/train_dataloader_"+str(batch_size)+".pth")
...
def train(model, train_dataloader, val_dataloader=None, epochs=4, lr = 1e-5, batch_size=32, evaluation=False):
    ...
    torch.save(model.state_dict(),"../../../trained_models/albert_large_v1_model_trained.pth")
