...
def train(model, train_dataloader, val_dataloader=None, epochs=4, evaluation=False):
    ...
    torch.save(model.state_dict(),"BERT_model_trained.pth")
    torch.save(model.state_dict(),"../../trained_models/BERT_model_trained.pth")
...
if __name__ == '__main__':
    ...
    bert_classifier, optimizer, scheduler,train_dataloader,val_dataloader = initialize(epochs=NUM_EPOCHS)
